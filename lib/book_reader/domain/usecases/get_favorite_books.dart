...
class GetFavoriteBooks extends UseCaseWithOutParams<List<Book>> {
  const GetFavoriteBooks(this._repository);

  final BooksRepository _repository;

  @override
  ResultFuture<List<Book>> call() async => _repository.getFavoriteBooks();
}
